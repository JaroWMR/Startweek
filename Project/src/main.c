...
int main(void)
{
	...
	while (1)
	{
		...
		{
			//https://arduino.stackexchange.com/questions/18625/converting-three-axis-magnetometer-values-to-degrees
			direction = atan2(magn_xyz_double[0], magn_xyz_double[1]) * 180 / M_PIL;
		}
